...
return [
    ...
    */
    'empty' => [
        ...
        'no_rooms_for_calendar' => 'No rooms match the current filters.',
    ],
    ...
    */
    'booking' => [
        ...
        'week_view' => 'Week',
        'month_view' => 'Month',
        'live_now' => 'Live: :occupied/:capacity now',
        'book_this_slot' => 'Click to book this time',
        'quick_availability' => 'Quick Availability',
        'check_availability' => 'Check Availability',
        'remaining_capacity' => 'Remaining capacity',
        'fill_all_fields' => 'Select a room, date, and time range first.',
        ...
        'legend' => [
            ...
            'room_availability' => 'Room timeline',
            'free' => 'Free',
            'partial' => 'Partially booked',
            'full' => 'Fully booked',
            'closed' => 'Closed (outside working hours)',
            'click_to_book' => 'Click-to-book slots',
            'slot_available' => 'Available — click to book',
    ...
    */
    'settings' => [
        ...
        'working_hours' => [
            'title' => 'Working Hours',
            'subtitle' => 'Set the days and hours your workspace is open. Bookings and check-ins outside these hours will be blocked once this is in use elsewhere.',
            'unrestricted_hint' => 'No hours configured yet — the workspace is currently treated as open at all times.',
            'open' => 'Open',
            'closed' => 'Closed',
            ...
            'invalid_days' => 'Could not save working hours — please try again.',
            'times_required' => 'Please set both an opening and closing time for every open day.',
            'times_equal' => 'Opening and closing time cannot be the same. For a day open around the clock, use 12:00 AM to 11:30 PM.',
        ],
    ],
