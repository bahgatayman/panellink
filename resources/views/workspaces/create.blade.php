...
@section('page-title', __('app.workspace.create_workspace'))

@section('content')
    <div class="max-w-2xl mx-auto">
        <a href="{{ route('workspaces.index') }}" class="text-sm text-blue-600 hover:text-blue-800 mb-4 inline-block">&larr; {{ __('app.btn.back_to_workspaces') }}</a>

        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h1 class="text-xl font-bold text-gray-900 mb-6">{{ __('app.workspace.create_workspace') }}</h1>
